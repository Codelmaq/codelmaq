...
export function MenuNavegacao() {
  ...
  const hasManagerAccess = isAdmin || isGestor;

  return (
    <nav className="flex flex-col space-y-2 p-4">
      {/* 🟢 VISÍVEL PARA TODOS (qualquer perfil) */}
      ...
      {/* 🟣 VISÍVEL PARA GESTOR (acesso de gestão, sem poderes administrativos) */}
      {isGestor && (
        <div className="pt-4 space-y-2">
          <p className="px-3 text-xs font-semibold text-gray-500 dark:text-gray-400 uppercase tracking-wider mb-2 flex items-center gap-2">
            <Briefcase size={12} /> Gestão
          </p>
